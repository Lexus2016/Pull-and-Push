...
`start.sh` створює віртуальне середовище, усе встановлює й відкриває панель за адресою
**http://127.0.0.1:8765**. Скрипт можна запускати повторно — додай `--port 8080`, щоб
