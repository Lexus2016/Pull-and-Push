...
Потрібні **Python 3.10+** і **Git**. Цього досить, щоб відкрити панель і створити проєкт;
щоб реально запустити оптимізацію, додатково треба один CLI ШІ-агента (крок 5).
...
**2 — Створити ізольоване середовище і встановити**
...
Відкрий надрукований URL — типово **http://127.0.0.1:8765**.

**4 — Створити перший проєкт (у браузері)**

Натисни **🚀 Новий проєкт зі зразка** → обери картку → дай назву → опиши мету →
**Створити** → натисни **▶ Запуск**.

**5 — Щоб запустити реальну оптимізацію, додай CLI агента**

Pull-and-Push керує вже встановленим CLI для ШІ-кодування; жодних API-ключів тут не
зберігається. Встанови й увійди хоча б в один, тоді обери його в проєкті: **claude**
(Anthropic), **codex** (OpenAI) або **opencode**. Порада: бери *різних* провайдерів для
виконавця й валідатора — однакова модель з обох боків має спільні сліпі плями.
